...
/**
 * Abstract base model for the translator application
 *
 * @since  1.0
 */
abstract class AbstractTranslatorDatabaseModel extends AbstractDatabaseModel
{
    /**
     * The model (base) name
     *
...
// echo "<br/>AbstractTranslatorDatabaseModel contruct database".print_r($database)."<hr/>\n";
