...
use Translator\Pagination\TranslatorPagination;
 ...
 * @since  1.0
 */
abstract class AbstractTranslatorListModel extends AbstractTranslatorDatabaseModel
{
    /**
     ...
     *
     * @param   TranslatorPagination  $pagination  The pagination object.
     *
     * @return  TranslatorPagination  The pagination object for the data set.
     *
     * @since   1.0
     */
    public function setPagination(TranslatorPagination $pagination)
    {
