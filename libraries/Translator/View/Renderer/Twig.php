...
// echo "Twig render data:".var_dump($this->data)."<br/>";
		try
		{
//            $tmpl = $this->load();
// echo htmlentities($tmpl->render($this->data))       ."<hr/>\n";
	...
	{
//  echo "Twig load template:".$this->getTemplate() . $this->config['template_file_ext']."<br/>\n";
